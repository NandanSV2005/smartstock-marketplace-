# Generated by Django 6.0.3 on 2026-03-03 15:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('retailer', 'Retailer'), ('wholesaler', 'Wholesaler'), ('admin', 'Admin')], default='retailer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_type', models.CharField(choices=[('kirana', 'Kirana Store'), ('supermarket', 'Small Supermarket'), ('restaurant', 'Restaurant'), ('cafe', 'Cafe'), ('bakery', 'Bakery'), ('hotel', 'Small Hotel'), ('other', 'Other')], default='kirana', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('business_name', models.CharField(max_length=255)),
                ('business_type', models.CharField(choices=[('fmcg', 'FMCG Distributor'), ('grocery', 'Grocery Wholesaler'), ('beverage', 'Beverage Distributor'), ('food_supplier', 'Food Supplier'), ('other', 'Other')], default='fmcg', max_length=30)),
                ('gst_number', models.CharField(blank=True, max_length=32, null=True)),
                ('address_line1', models.CharField(max_length=255)),
                ('address_line2', models.CharField(blank=True, max_length=255, null=True)),
                ('city', models.CharField(max_length=100)),
